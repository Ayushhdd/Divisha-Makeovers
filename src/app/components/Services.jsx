            ...
            >
              ...
              <div
                className="
                  ...
                  opacity-[0.35] md:opacity-0
                  scale-100 md:scale-[1.05]
                  transition-all
                  duration-700
              ...
              <div className="relative z-10">
                <h3 className="text-sm sm:text-base md:text-2xl mb-3 tracking-[0.04em] font-medium leading-snug">
                  {service.title}
                </h3>

                <p className="hidden md:block text-white/75 leading-relaxed max-w-md">
                  {service.desc}
                </p>

                <span className="inline-block mt-5 md:mt-6 text-xs md:text-sm tracking-wider text-pink-300 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-700">
                  View Packages {"\u2192"}
                </span>
              </div>
              </Link>
