...
export default function RootLayout({ children }) {
  const localBusinessSchema = {
    ...
    alternateName: [
      "Divisha Makeup Artist Jalandhar",
      "Divisha Bridal Makeup Artist",
    ],
    url: siteUrl,
    logo: `${siteUrl}/logo/dm2.png`,
    image: [
      `${siteUrl}/logo/dm2.png`,
      `${siteUrl}/about/about.jpg`,
      `${siteUrl}/gallery/sgl.jpg`,
    ],
    description:
    ...
    knowsAbout: [
      ...
      "Nail extensions",
      "Makeup artist in Jalandhar",
      "Bridal makeup artist in Punjab",
    ],
    sameAs: [
